    ...
    with torch.no_grad():
        with tqdm(total=len(test_loader)) as pbar:
            for idx, data in enumerate(test_loader):
                ...
                text_feature = MyCLIP.text_encoder(text)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default=r'/your/path/for/BrainSeg_model.pt', help='path to the model')
    parser.add_argument('--clip_dir', type=str, default=r'/your/path/for/BCLIP.pt', help='path to the B-CLIP model')
