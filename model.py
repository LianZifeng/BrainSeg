"""
This code is modified and extended based on Swin UNETR (Swin Transformers for Semantic Segmentation 
of Brain Tumors in MRI Images).

Original Swin UNETR Paper:
...
- [Describe your specific modifications here]
- [For example: Modified encoder structure / Adjusted patch size / Adapted for specific dataset / etc.]

If you use this code, please cite the original Swin UNETR paper above and reference this project as appropriate.
"""
...
from cross_att import Basic_block
...
class MySwinUNETR(nn.Module):
    ...
    def forward(self, x_in, y):
        ...
        attention = self.attention(hidden_states_out[4], y)
        dec4Seg = self.encoder10(attention)
