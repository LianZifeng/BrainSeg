...
import torch
from monai.utils import look_up_option, optional_import, ensure_tuple_rep
import itertools
import torch.nn.functional as F
from monai.networks.layers import trunc_normal_, DropPath
...
class ImageEncoder(nn.Module):
    ...
    def forward(self, x_in):
        ...
        last_feature = hidden_states_out[-1].mean(dim=(2, 3, 4))
        feature = self.proj(last_feature)
        return feature